...
class UserRequestsPageEd extends StatefulWidget {
  static List<MyAccepted> requestList = [];
  static List<MyAccepted> acceptedRequestList = [];

  const UserRequestsPageEd({Key? key}) : super(key: key);

  @override
  State<UserRequestsPageEd> createState() => _UserRequestsPageEdState();
}

class _UserRequestsPageEdState extends State<UserRequestsPageEd> {
    ...
    fetchData().then((subjectFromServer) {
      ...
      setState(() {
        ...
        for (var reservation in reservationsLists) {
          print("$reservation");
          UserRequestsPageEd.requestList.add(reservation);
        }
      });
    ...
    myPendingReservations().then((subjectFromServer) {
      setState(() {
        ...
        for (var pendingReservation in pendingList) {
          ...
          UserRequestsPageEd.requestList.add(pendingReservation);
        }
      });
    });
                          ...
                          return Expanded(
                            child: Container(
                              ...
                              child: ListView(
                                shrinkWrap: true,
                                children: <Widget>[
                                  ...UserRequestsPageEd.requestList
                                      .map((val) {
                                    return Column(
                                      children: [
                                        Row(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: ListView(
                                children: <Widget>[
                                  ...UserRequestsPageEd.requestList.map((val) {
                                    return Column(
                                      children: [
                                        Row(
                                          mainAxisAlignment:
