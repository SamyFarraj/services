...
class AdminRequestsPageEd extends StatefulWidget {
  AdminRequestsPageEd({Key? key}) : super(key: key);

  final List<MyAccepted> adminAcceptedRequestListEd = [];

  @override
  State<AdminRequestsPageEd> createState() => _AdminRequestsPageEdState();
}

AdminRequestsPageEd arp = AdminRequestsPageEd();
...
class _AdminRequestsPageEdState extends State<AdminRequestsPageEd> {
...
/*
  ...
  */
  ...
  Widget _acceptedRequests() => Stack(
        children: <Widget>[
          _backgroundImage(),
          _colorCorrectionLayer(),
          BlocConsumer<AdminLevelCubit, AdminLevelState>(
